...
DINO_SCALE = 2  # 32x32 станет 64x64
CACTUS_SCALE = 2  # тоже увеличим

# Размеры спрайтов после масштабирования
DINO_SIZE = (32 * DINO_SCALE, 32 * DINO_SCALE)
CACTUS_SIZE = (32 * CACTUS_SCALE, 32 * CACTUS_SCALE)
...
# Пути к изображениям
DINO_IMG_PATH = "dino.png"
CACTUS_IMG_PATH = "cactus.png"

# Классы
class Dino(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = load_image(DINO_IMG_PATH, DINO_SIZE, (100, 100, 100))
...
class Cactus(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = load_image(CACTUS_IMG_PATH, CACTUS_SIZE, (34, 139, 34))
        self.rect = self.image.get_rect()
...
def game_loop():
    ...
    while True:
        ...
        draw_text(f"Счёт: {score // 10}", font, BLACK, 50, 10)
        draw_text(f"SPACE - прыжок", font, BLACK, 100, 40)
